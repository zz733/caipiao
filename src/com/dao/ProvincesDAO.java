 ...
 * 
 * @see com.pojo.Provinces
 * @author MyEclipse Persistence Tools
 */
public class ProvincesDAO extends HibernateDaoSupport {
	...
	public Provinces findById(java.lang.Integer id) {
		...
		try {
			Provinces instance = (Provinces) getHibernateTemplate().get(
					"com.pojo.Provinces", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Provinces instance) {
	...
	public Provinces merge(Provinces detachedInstance) {
		...
		try {
			Provinces result = (Provinces) getHibernateTemplate().merge(
					detachedInstance);
