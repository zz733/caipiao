...
public class GoodsDAO extends HibernateDaoSupport {
	...
	public static final String GIMAGES2 = "gimages2";
	public static final String GIMAGES3 = "gimages3";
	public static final String GIMAGES4 = "gimages4";
	public static final String GIMAGES5 = "gimages5";
	...
	public List findByGimages2(Object gimages2) {
		return findByProperty(GIMAGES2, gimages2);
	}

	public List findByGimages3(Object gimages3) {
		return findByProperty(GIMAGES3, gimages3);
	}

	public List findByGimages4(Object gimages4) {
		return findByProperty(GIMAGES4, gimages4);
	}

	public List findByGimages5(Object gimages5) {
		return findByProperty(GIMAGES5, gimages5);
	}
