...
//	    String hqlsum = "select count(*) from Kaijiang";
		String hql = "select qishu, qiu1,qiu2,qiu3,qiu4,qiu5,kudu,hewei,chu3yu0,chu3yu1,chu3yu2 from Pailiewu order by qishu asc ";
...
//	    String hqlsum = "select count(*) from Kaijiang";
	...
	public String get3d1() {
		...
		//期数，球1，球2，球3，跨度，和尾
		String hql = "select qishu, qiu1, qiu2,qiu3,kudu, hewei from Kaijiang3d order by qishu desc";
		List list = hqldao.pageQuery(hql, 1, 30);
		Collections.sort(list,new SortKaijiang());
		JsonConfig jsonConfig = new JsonConfig();
		JsonFilter.ignoredSet(jsonConfig);
