...
@Controller
@RequestMapping("/wxpayNotify2.do")
public class WeixinPayNotify2Action {
	@Autowired
	...
	public String execute(HttpServletRequest request,
		...
		// 获取请求数据
		PayNotify payNotify = XMLConverUtil.convertToObject(PayNotify.class,str);
		...
		if ("SUCCESS".equals(payNotify.getResult_code())
			...
			// if (trade_no.startsWith("jhthg"))
			{
				...
				String status=dailiAlipayService.updateZhifuOrderStatus(trade_no, money);
				if(status.equals("success")){
					System.out.println("支付成功，修改微信订单状态成功");
				}
