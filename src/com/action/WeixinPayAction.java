...
public class WeixinPayAction {
	...
	public String toPay(HttpServletRequest request, HttpServletResponse response)
		...
		String notifyUrl = URLManager.getServerURL(request) + "/wxpayNotify.do"; // 异步通知地址http://iptv2.vicp.net/jht_1
		...
		//E:\Tomcat8\webapps\ShuangSeQiu\tempImages\fc1be50cd960450ba1af943e069f4163.png
	...
	public String toPay2(HttpServletRequest request, HttpServletResponse response)
		...
		String mch_id = WeixinConfig.MCH_ID; // 商户号
		String payKey = WeixinConfig.PAY_KEY; // 支付key
		String notifyUrl = URLManager.getServerURL(request) + "/wxpayNotify2.do"; // 异步通知地址http://iptv2.vicp.net/jht_1
		Unifiedorder unifiedorder = new Unifiedorder();
		unifiedorder.setAppid(appid);
		unifiedorder.setBody(name);// 商品描述
		unifiedorder.setDevice_info("");
