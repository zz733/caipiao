...
public class AlipayNotify {
	...
	private static boolean getSignVeryfyByPc(Map<String, String> Params,
		...
		if (AlipayConfig.pc_sign_type.equals("MD5")) {
	...
	public static boolean verify(Map<String, String> params) throws UnsupportedEncodingException {
		...
		System.out.println("QQQQQ来了2");
		String responseTxt = "true";
		if (params.get("notify_id") != null) {
			String notify_id = params.get("notify_id");
			System.out.println("QQQQQ来了3");
			responseTxt = verifyResponse(notify_id);
		}
		System.out.println("QQQQQ来了4");
		String sign = "";
		if (params.get("sign") != null) {
			sign = params.get("sign");
		}
		boolean isSign = getSignVeryfyByPc(params, sign);
		System.out.println("QQQQQ来了5");
