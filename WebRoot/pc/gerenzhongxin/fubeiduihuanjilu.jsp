	...
	<table class="table table-border table-bordered table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="td-manage">
				<a title="详情"  onclick="ckxiangqing('兑换详情','${pageContext.request.contextPath}/shiyong.do?p=getOrderdetailByorId&id='+'${m.orId}','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe665; </i></a>
				</td>
			</tr>
			</c:forEach>
...
/*查看详情*/
function ckxiangqing(title,url,w,h){
