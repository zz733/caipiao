...
<link type="text/css"
	...
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/pc/css/main.css"
	rel="stylesheet" type="text/css" />
<!--必要样式-->
<link href="http://cdn.bootcss.com/bootstrap/3.3.6/css/bootstrap.css"
	rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/pc/css/city-picker.css"
	rel="stylesheet" type="text/css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/pc/css/shouhuo.css" />
<!--[if lt IE 9]>
			...
			<div class="visible-xs header-xs">
				...
				<div id="header-xs-menu" class="navbar-collapse collapse">
					<ul class="nav navbar-nav header-xs-nav">
						<li class="active"><a href="${pageContext.request.contextPath }/userinfo.do?p=gerenxinxi"><span
							class="glyphicon glyphicon-user"></span>个人信息</a></li>s
		...
		<div class="content-wrap">
			...
			<div class="content">
				<div id="main">
					...
					<div id="content">
						<div id="div_zi">
							<span class="div_span2 div_span"> 新增收货地址</span><span
								class="div_span2">下面都为必填项</span>
						</div>
						<div id="div_body">
		    	    ...
		    	    <span class="div_span2">所在地址</span><i class="div_span">*</i>
		    	    <div class="div_div2"><select style="width: 150px;height: 25px;"  id="div_address" onblur="checkaddress()" placeholder="请选择省市区"></select><label id="address"></label></div>
		    	    <!--<div id="div_select"><select style="width: 200px;" placeholder=""></select></div>-->
							<!--</div>-->
						...
						<input id="city-picker3" class="form-control"  readonly type="text" value="江苏省/常州市/溧阳市" data-toggle="city-picker">
					</div><label id="address" ></label>
					</div>-->
									<select style="width: 90px;">
										<option value="${a.areas.citys.provinces.proId}">${a.areas.citys.provinces.proName}</option>
									</select> <select style="width: 90px;">
										<option value="${a.areas.citys.cityId}">${a.areas.citys.cityName}</option>
									</select> <select style="width: 90px;" id="area">
										<option value="${a.areas.areaId}">${a.areas.areaName}</option>
									</select>
								</div>
								...
								<div class="div_address2">
									...
									<div id="" class="div_div2">
										<textarea rows="2" cols="40" autocomplete="off"
											id="div_xxaddress" onblur="checkxxaddress()"
											placeholder="建议您如实填写详细收货地址，例如街道名称，门牌号码，楼层和房间号等信息">${a.adDetail }</textarea>
										<label id="xxaddress"></label>
									</div>

								</div>
								<!--<div class="div_address2">
		    	<lable class="div_span2" >邮政编码</lable><span class="div_span"></span>
		    	<div class="div_div2"><input type="text"  id="div_map" onblur="checkmap()" placeholder="请输入正确的邮政编码" /> <label id="map" ></label></div>
		    	
		    	</div>-->
								<div class="div_address2">
									<span class="div_span2">收货人姓名</span><i class="div_span">*</i>
									<div id="" class="div_div2">
										<input type="text" onblur="checkusername()" id="div_name"
											placeholder="收货人姓名长度为2-20个字符" value="${a.adName }" /><label
											id="name"></label>
									</div>
								...
								<div class="div_address2">
									...
									<div id="" class="div_div2">
										<input type="text" onblur="checkphone()" id="div_phone"
											placeholder="请输入正确的手机号" value="${a.adphone }" /><label
											id="phone"></label>
									</div>
								</div>
								<div class="div_address2">
									...
									<div id="div_button">
										<input type="button" class="btn btn-primary" id="button_click"
											value="保存" onclick="checkgo('${a.adId}')" /><input
			...
			<table  class="table">
				...
				<tr align="center">
					...
					<td class="td">15698084390</td>
					<td class="td"><a href="">修改</a>|<a href="">删除</a></td>
					<td><button style="margin-top: 6px;" class="btn btn-primary">默认地址</button></td>
				</tr>
				<tr align="center">
					<td class="td">哈哈</td>
					<td class="td">湖南湘潭</td>
					...
					<td class="td">400231</td>
					<td class="td">15698084390</td>
					<td class="td"><a href="xiugaiaddress.html">修改</a>|<a href="">删除</a></td>
					<td><button style="margin-top: 6px;" class="btn btn-primary">默认地址</button></td>
				</tr>
				</tbody>
			</table>
			...
			<script
				src="${pageContext.request.contextPath}/pc/js/bootstrap.min.js"
			...
			<script
				src="${pageContext.request.contextPath}/pc/js/city-picker.data.js"></script>
			...
			<script
				src="${pageContext.request.contextPath}/pc/js/jquery-2.1.4.min.js"
				type="text/javascript"></script>
			<script src="${pageContext.request.contextPath}/pc/js/nprogress.js"
				type="text/javascript"></script>
							...
							.confirm(
									...
									function() {
										...
										$
												.ajax({
													type : "post",
													url : "${pageContext.request.contextPath}/address.do?p=updateAddressById",
													data : {
														adId : id,
														address2 : address2,
													...
													success : function() {
														layer
																.msg(
																		...
																		function() {
																			location.href = "${pageContext.request.contextPath}/address.do?p=getAll";
																		});
													},
													error : function() {
														layer.msg("保存失败！", {
						...
						function() {
							...
							jQuery.ajax({
								...
								success : function(data) {
									...
									result = jQuery(data).find(
											".row .news-list");
									//newHref获取返回的内容中的下一页的链接地址
									nextHref = jQuery(data).find(
											"#pagination a").attr("href");
									jQuery(this).attr("href", _url);
									if (nextHref != undefined) {
										jQuery("#pagination a").attr("href",
												nextHref);
									} else {
