...
<section class="container user-select">
			...
			<div class="visible-xs header-xs">
				...
				<div id="header-xs-menu" class="navbar-collapse collapse">
					<ul class="nav navbar-nav header-xs-nav">
						<li class="active"><a href="${pageContext.request.contextPath }/pc/gerenzhongxin/gerenxinxi.jsp"><span
							class="glyphicon glyphicon-user"></span>个人信息</a></li>
  ...
  <div class="content-wrap"><!--内容-->
    <div class="content">
    	<div id="header">
				<span id="header_span">微信绑定设置</span>
				</div>
    	...
    	<ul style="margin-left: 120px;margin-top: -95px;">
    		<li><h3>尊敬的<span style="color: red;">${u.usersName}</span>用户，你好！</h3></li>
    		<li><h4>绑定的账号为：${u.usersWeixin}<a style="color:#3990C6;font-size:14px;text-decoration:none;margin-left:20px;top:-20px" href="${pageContext.request.contextPath}/pc/gerenzhongxin/bangdingwx.jsp">修改</a></h4></li>
    	</ul>
    	</c:forEach>
