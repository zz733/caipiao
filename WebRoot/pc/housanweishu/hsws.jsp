...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/pc/css/hswh.css" />
<link rel="stylesheet"
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/pc/housanweishu/hsws2.js"></script>
</head>
...
<body>
	<div style="width: 80%; margin: 0 auto;">
		...
		<div class="" style="padding: 5px; width: 100%;">
			...
			<table class="tabl" border="0" id="hswsTu">
				<thead>
					<tr>
