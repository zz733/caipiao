...
<script type="text/javascript" src="${pageContext.request.contextPath }/admin/static/h-ui/js/H-ui.min.js"></script> 
	...
	<!--登录和注册-->
	<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-1311" data-genuitec-path="/ShuangSeQiu/WebRoot/pc/yonghudenglu/denglu_3d.jsp">		
		  <div id="main" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-1311" data-genuitec-path="/ShuangSeQiu/WebRoot/pc/yonghudenglu/denglu_3d.jsp">
						...
						switch(data)
		                 { 
		                   ...
		                   case "1":
		                      ...
		                      top.location = "${pageContext.request.contextPath}/pc/3d/";
		                      break;
