...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-1298" data-genuitec-path="/ShuangSeQiu/WebRoot/pc/pailiewu/daohang.jsp">
	<div id="main" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-1298" data-genuitec-path="/ShuangSeQiu/WebRoot/pc/pailiewu/daohang.jsp">
        <div class="container">
        <ul class="nav nav-justified">
                          <li><a href="${pageContext.request.contextPath}/main.jsp" target="top">首页</a></li>
                         <li><a href="${pageContext.request.contextPath}/pc/pailiewu/paiwuzhixuan.jsp"  target="zh">排五直选</a></li>
                         <li><a href="${pageContext.request.contextPath}/pc/pailiewu/pwzhzs.jsp" target="zh">排五综合选</a></li>
						 <li><a href="${pageContext.request.contextPath}/pc/pailiewu/paisanzuxuan.jsp"  target="zh">排三组选</a></li>
						 <li><a href="${pageContext.request.contextPath}/pc/pailiewu/houpaisanzoushi.jsp"  target="zh">后三组选</a></li>
				</ul>  
      </div>
	</div>
