...
/*
			if (j == 5) {
				if (tdArr[1] == tdArr[2] || tdArr[1] == tdArr[3]
						|| tdArr[1] == tdArr[4] || tdArr[1] == tdArr[5] 
				|| tdArr[2] == tdArr[3] || tdArr[2] == tdArr[4] || tdArr[2] == tdArr[5]
				|| tdArr[3] == tdArr[4] || tdArr[3] == tdArr[5] || tdArr[4] == tdArr[5]) {
