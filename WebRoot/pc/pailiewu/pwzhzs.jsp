...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/pc/pailiewu/pwzhzs.css" />
<link rel="stylesheet"
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-1307" data-genuitec-path="/ShuangSeQiu/WebRoot/pc/pailiewu/pwzhzs.jsp">
<div style="width:1200px;margin:auto;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-1307" data-genuitec-path="/ShuangSeQiu/WebRoot/pc/pailiewu/pwzhzs.jsp">
	 <div style="width: 100%; margin: auto;">
		...
		<div class="" style="padding: 5px; width: 100%;border: 0px solid red;">
			<table class="tabl" border="1" style="width:820px;"
				id="hswsTu">
				<thead>
					<tr>
...
<div id="Move">
 <div class="btn btn-group btn_hs" style="float:right;margin-top:35px;">
...
color:white;
			...
			<!--vip选号 -->
		<div style="margin:0px auto;width:100%;margin-top:20px;">	
			<div class="container" style="width:1200px;">
		<div id="vipxh" style="display: block;">
				<div style="height:50px;"> <!-- id="vipxh" -->
					<div class="vipxh_tx">
						<p>VIP选号区</p>
					</div>
					<!--自选框-->
					<!--选组-->
						...
						padding: 0 10%;
							...
							<option value="0" selected="selected" style="text-align: center;color: black;">选三</option>
							<option value="1" style="text-align: center;color: black;">选四</option>
							<option value="2" style="text-align: center;color: black;">选五</option>
						</select>
						<span class="xx">▼</span>
					</div>
					<div class="btnleft">
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/pc/pailiewu/pwzhzs.js?1234567"></script>
