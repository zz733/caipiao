...
<body>
	<form id="f"
		action="${pageContext.request.contextPath}/pailiewu.do?p=fenye"
		method="post" autocomplete="off">
		<nav class="breadcrumb">
			<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>
			排列五管理 <span class="c-gray en">&gt;</span> 排列五数据 </a>
		</nav>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<span class="l"> <a href="javascript:;"
			onclick="qiuhao_add('球号入库','${pageContext.request.contextPath}/pailiewu.do?p=getMaxQishu','800','450')"
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="11">排列五数据</th>
				</tr>
				<tr class="text-c">
					<th width="30">编号</th>
					<th width="50">期数</th>
				...
				<c:forEach items="${map.list}" var="m">
					<tr class="text-c">
						...
						<td class="td-manage"><a title="编辑"
							...
							onclick="qiuhao_update('编辑','${pageContext.request.contextPath}/pailiewu.do?p=toEdit&id=${m.id}','800','450')"
							class="ml-5" style="text-decoration: none"><i
								class="btn btn-success">编辑</i> </a> <a title="删除"
							_href="${pageContext.request.contextPath }/pailiewu.do?p=del&id=${m.id}"
...
/>
	...
	function del(id,a)
	{
	   var url  = '${pageContext.request.contextPath }/pailiewu.do?p=del';
	   var data = {id:id};
