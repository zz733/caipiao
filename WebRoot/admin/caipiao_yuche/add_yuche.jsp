			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-3">
					<input type="text" class="input-text" autocomplete="off"
						placeholder="" name="qihao" id="qihao">
				</div>
...
$("#button").click(function(){
    ...
    var qihao = $("#qihao").val();
     ...
     var url = "${pageContext.request.contextPath}/yucheBack.do?p=add";
     var data = {qihao:qihao,content:content,kaijiangtime:kaijiangtime,type:$("#type").val(),title:title};
