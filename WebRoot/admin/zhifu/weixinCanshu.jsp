...
<body>
	<nav class="breadcrumb">
		...
		微信设置 <span class="c-gray en">&gt;</span>微信参数
	</nav>

	<div class="pd-20">
		<div class="form form-horizontal" id="form-member-add">
			<div class="row cl">
				<label class="form-label col-4">APP_ID：
				</label>
			...
			<div class="row cl" style="margin-top: 20px;">
				<label class="form-label col-4">APP秘钥：
				</label>
				<div class="formControls col-4">
			...
			<div class="row cl" style="margin-top: 20px;">
				<label class="form-label col-4">商户号：
				</label>
				<div class="formControls col-4">
					<input type="text" class="input-text" value="${wxmap.mchid}"
						placeholder="" id="mchid" name="mchid">
				</div>
				<div class="col-4"></div>
			</div>

			<div class="row cl" style="margin-top: 20px;">
				<label class="form-label col-4">支付密钥：
				</label>
				<div class="formControls col-4">
					<input type="text" class="input-text" value="${wxmap.paykey}"
						placeholder="" id="paykey" name="paykey">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl" style="margin-top: 20px;">
				<label class="form-label col-4">Token：
				</label>
				<div class="formControls col-4">
					<input type="text" class="input-text" value="${wxmap.token}"
						placeholder="" id="token" name="token">
				</div>
				<div class="col-4"></div>
				<div class="formControls" style="margin-top: 60px; margin-left:7%">
					<label class="form-label col-4">当前状态&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;
						<c:choose>
							<c:when test="${wxmap.status==0}">
								<span style="color: red" class="qiyong">已启用</span>
							</c:when>
							<c:otherwise>
								<span style="color: red" class="jinyong">已禁用</span>
							</c:otherwise>
						</c:choose> </label>
				</div>
			</div>
			<div class="row cl" style="margin-top: 20px; margin-left: 30%">
				<div class="col-8 col-offset-4" style="margin-left: 5%;">
					<a style="text-decoration: none;" class="btn btn-primary radius"
						onclick="xiugai_status(this,'${wxmap.status}')"
						href="javascript:void(0)" title="修改状态"> <c:choose>
							<c:when test="${wxmap.status==1}">
												&nbsp;&nbsp;启  用&nbsp;&nbsp;
											</c:when>
							<c:otherwise>
												&nbsp;&nbsp;禁  用&nbsp;&nbsp;
											</c:otherwise>
						</c:choose> </a> <input class="btn btn-primary radius" onclick="return tijiao()"
