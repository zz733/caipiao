...
<body>
	<nav class="breadcrumb">
		...
		支付宝设置 <span class="c-gray en">&gt;</span>支付宝参数
	</nav>

	<div class="pd-20">
		<div class="form form-horizontal" id="form-member-add">
			<div class="row cl">
				<label class="form-label col-4">合作身份者ID：
				</label>
			...
			<div class="row cl" style="margin-top: 20px;">
				<label class="form-label col-4">收款支付宝账号：
				</label>
				<div class="formControls col-4">
			...
			<div class="row cl" style="margin-top: 20px;">
				<label class="form-label col-4">商户的私钥：
				</label>
				<div class="formControls col-4">
			...
			<div class="row cl" style="margin-top: 20px;">
				<label class="form-label col-4">支付宝的公钥：
				</label>
				<div class="formControls col-4">
					<input type="text" class="input-text"
						value="${alipay.alipay_public_key}" placeholder=""
						id="alipay_public_key" name="alipay_public_key">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl" style="margin-top: 20px;">
				<label class="form-label col-4">PC支付MD5：
				</label>
				<div class="formControls col-4">
