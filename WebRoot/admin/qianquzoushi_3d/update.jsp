...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-4 col-sm-4">
				<input type="text" value="${k.time }" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss'})" id="commentdatemin" name="commentdatemin" class="input-text Wdate">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-4 col-sm-4">
			  ...
			  <input type="text" class="input-text" value="${k.qishu}" placeholder="开奖期数" id="Qishu" name="qishu">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-4 col-sm-4">
			<input type="text" value="${k.qiu1 }" class="input-text" autocomplete="off"  placeholder="第一个球" id="qiu1" name="qiu1">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-4"><span class="c-red">*</span>第二个球：</label>
		<div class="formControls col-xs-4 col-sm-4">
			<input type="text" value="${k.qiu2 }" class="input-text" autocomplete="off"  placeholder="第二个球" id="qiu2" name="qiu2">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-4"><span class="c-red">*</span>第三个球：</label>
		<div class="formControls col-xs-4 col-sm-4">
			<input type="text" value="${k.qiu3 }"  class="input-text" autocomplete="off"  placeholder="第三个球" id="qiu3" name="qiu3">
		</div>
	</div>
		<div class="row cl">
		<label class="form-label col-xs-4 col-sm-4"><span class="c-red">*</span>第四个球：</label>
		<div class="formControls col-xs-4 col-sm-4">
			<input type="text" value="${k.qiu4 }" class="input-text" autocomplete="off"  placeholder="第四个球" id="qiu4" name="qiu4">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-4"><span class="c-red">*</span>第五个球：</label>
		<div class="formControls col-xs-4 col-sm-4">
			<input type="text" value="${k.qiu5 }"  class="input-text" autocomplete="off"  placeholder="第五个球" id="qiu5" name="qiu5">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-4 col-sm-4">
			<input type="text" value="${k.blue1 }"   class="input-text" autocomplete="off"  placeholder="蓝球1" id="blue1" name="blue1">
		</div>
	</div>
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-4"><span class="c-red">*</span>蓝球2：</label>
		<div class="formControls col-xs-4 col-sm-4">
			<input type="text" value="${k.blue2 }"   class="input-text" autocomplete="off"  placeholder="蓝球2" id="blue2" name="blue2">
		</div>
	</div>
...
$(function(){
	...
	$("#form-qiuhao-add").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				type: 'post',
				url: "${pageContext.request.contextPath}/qianquzoushi3d.do?p=update" ,
