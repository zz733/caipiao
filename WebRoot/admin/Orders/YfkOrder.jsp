...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 订单管理 <span class="c-gray en">&gt;</span> 已付款订单 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
<form  action="${pageContext.request.contextPath}/order.do?p=finOrder1" method="post" autocomplete="off">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr>
				<th scope="col" colspan="8">已付款订单</th>
			</tr>
			<tr class="text-c">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="td-manage">
				<a title="添加物流信息" onclick="wuliufahuo('物流信息','${pageContext.request.contextPath}/order.do?p=findOrderById&orid=${m.orId}','800','400')"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function wuliufahuo(title,url,w,h){
