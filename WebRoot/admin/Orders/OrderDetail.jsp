...
<div class="page-container">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<div class="row cl" >
			<div class="col-xs-1 col-sm-7 col-xs-offset-1 col-sm-offset-11">
				<a  href="javascript:history.go(-1)"><button class="btn btn-default radius" type="button">&nbsp;&nbsp;返回&nbsp;&nbsp;</button></a>
			</div>
		</div>
	</div>
<!--_footer 作为公共模版分离出去-->
