...
<div class="page-container" >
	<c:forEach items="${list}" var="m">
		<div class="row cl">
			<label class="form-label col-xs-6 col-sm-2 "><span class="c-red">*</span>订单号:</label>
			<div class="formControls col-xs-6 col-sm-9">
				<input type="text" class="input-text" value="${m.orOrdernumber}" placeholder="" id="orOrdernumber" name="orOrdernumber" readonly="readonly">
			</div>
				<input type="hidden" value="${m.orId}" name="orId" id="orId">
		</div><br>
		<div class="row cl">
			<label class="form-label col-xs-6 col-sm-2">用户账号:</label>
			<div class="formControls col-xs-6 col-sm-9">
				<input type="text" class="input-text" value="${m.userinfo.usersName }" placeholder="" id="goodname" name="goodname" readonly="readonly">
			</div>
		</div><br>
		<div class="row cl" >
		<label class="form-label col-xs-6 col-sm-2">订单状态:</label>
		<div class="formControls col-xs-6 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="adminRole" size="1" id="orStatus" >
		...
		<div class="row cl" >
			<div class="col-xs-6 col-sm-9 col-xs-offset-7 col-sm-offset-8">
				<button id="AddBtn" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe632;</i> 修改订单</button>
...
$(function(){ 
	$("#AddBtn").click(function(){
		...
		if(orStatus==null || ""==orStatus){
			layer.msg("订单状态不能为空!",{icon:6,time:1000});
			return false;
		}
		layer.confirm("修改订单?",function(index){
		
			//&goodname="+goodname+"&goodprice="+goodprice+"&gooddetail="+gooddetail+"&file="+image
			$.ajax({
				url:"${pageContext.request.contextPath }/order.do?p=updateOrderStatus",
				data:"&orId="+orId+"&orStatus="+orStatus,
				type:"post",
				success: function(data,status){
					layer.msg("修改订单成功!",{icon:6,time:2000});
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: 'http://127.0.0.1:8080/ShuangSeQiu/upload.do',
            // runtimeOrder: 'flash',
