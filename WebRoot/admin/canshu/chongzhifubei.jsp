	...
	<form action="" method="post" class="form form-horizontal" id="form-user-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-3 col-sm-2">		
				<input type="text" class="input-text"  value="${fubei}" id="chongzhifubei" name="chongzhifubei"/>
			</div>
			<label class="form-label col-xs-5 col-sm-2">
...
function xiugai()
{	
	var chongzhifubei=$("#chongzhifubei").val();
	var num = /^[0-9]+(.[0-9]{1,2})?$/;
	if(chongzhifubei==null || ""==chongzhifubei){
		layer.msg("请输入赠送百分比!",{icon:2,time:1000});
		return false;
	}
	if(!num.test(chongzhifubei)){
	...
	$.ajax({
		...
		url:"${pageContext.request.contextPath}/jccs.do?p=xgjccsfb",
		data:{chongzhifubei:chongzhifubei},
		type:"post",
