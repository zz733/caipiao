	...
	<form action="" method="post" class="form form-horizontal" id="form-user-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-4">		
				<input type="text" class="input-text" value="${dsodds}" id="dsodds" name="dsodds">
			</div>
		</div>
		<div class="row cl">
...
function xiugai()
{	
	var dsodds=$("#dsodds").val();
	var num = /^[0-9]+(.[0-9]{1,2})?$/;
	if(dsodds==null || ""==dsodds){
		layer.msg("请输入单双大小赔率!",{icon:2,time:1000});
		return false;
	}
	if(!num.test(dsodds)){
	...
	$.ajax({
		url:"${pageContext.request.contextPath}/jccs.do?p=xgjccsds",
		data:{dsodds:dsodds},
		type:"post",
