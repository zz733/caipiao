	...
	<form action="" method="post" class="form form-horizontal" id="form-user-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-4">		
				<input type="text" class="input-text" value="${ysodds}"  id="ysodds" name="ysodds">
			</div>
		</div>
		<div class="row cl">
...
function xiugai()
{	
	var ysodds=$("#ysodds").val();
	var num = /^[0-9]+(.[0-9]{1,2})?$/;
	if(ysodds==null || ""==ysodds){
		layer.msg("请输入余3赔率!",{icon:2,time:1000});
		return false;
	}
	if(!num.test(ysodds)){
	...
	$.ajax({
		url:"${pageContext.request.contextPath}/jccs.do?p=xgjccsys",
		data:{ysodds:ysodds},
		type:"post",
