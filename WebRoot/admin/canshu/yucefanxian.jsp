	...
	<form action="" method="post" class="form form-horizontal" id="form-user-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-4">		
				<input type="text" class="input-text" value="${yucehfanxian}"  id="yucehfanxian" name="yucehfanxian">
			</div>
		</div>
		<div class="row cl">
...
function xiugai()
{	
	var yucehfanxian=$("#yucehfanxian").val();
	var num = /^[0-9]+(.[0-9]{1,2})?$/;
	if(yucehfanxian==null || ""==yucehfanxian){
		layer.msg("请输入返现金额!",{icon:2,time:1000});
		return false;
	}
	if(!num.test(yucehfanxian)){
		layer.msg("格式有误",{icon:2,time:1000});
		$("#ysodds").val("");
		return false;
	}
	$.ajax({
		url:"${pageContext.request.contextPath}/jccs.do?p=xg_yucehfanxian",
		data:{yucehfanxian:yucehfanxian},
		type:"post",
