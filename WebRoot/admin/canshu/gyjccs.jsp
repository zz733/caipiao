	...
	<form action="" method="post" class="form form-horizontal" id="form-user-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-4">		
				<input type="text" class="input-text" value="${gyjccs}"  id="gyjccs" name="gyjccs">
			</div>
		</div>
		<div class="row cl">
...
function xiugai()
{	
	var gyjccs=$("#gyjccs").val();
	var num = /^[0-9]+(.[0-9]{1,2})?$/;
	if(gyjccs==null || ""==gyjccs){
		layer.msg("请填写竞猜次数!",{icon:2,time:1000});
		return false;
	}
	if(!num.test(gyjccs)){
	...
	$.ajax({
		url:"${pageContext.request.contextPath}/jccs.do?p=xggyjccs",
		data:{gyjccs:gyjccs},
		type:"post",
