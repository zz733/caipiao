...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/static/h-ui/css/login.css" />
	...
	<body>
		<div class="main">
			<div class="head">
				...
				<span>易乐智能彩票选号系统管理平台1.0</span>
			</div>
			<div class="content">
				<img src="${pageContext.request.contextPath}/admin/static/h-ui/images/tu.png" />
				<div class="right">
					<div class="info">
						<p class="tou">用户登录</p>
