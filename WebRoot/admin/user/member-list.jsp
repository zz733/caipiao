...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户管理 <span class="c-gray en">&gt;</span> 所有用户  <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<form action="${pageContext.request.contextPath}/user.do?p=userlisting&type=${usersmap.type}" method="post" name="f" id="f" autocomplete="off">
	...
	<table class="table table-border table-bordered table-bg table-sort">
		...
		<!-- 	    <td>   
			...
			<c:if test="${not f}">
			<tr class="text-c">
			<th scope="col" colspan="12">暂无数据</th>                 
		     </tr>
		   	</c:if> 
		</tbody>
	</table>
