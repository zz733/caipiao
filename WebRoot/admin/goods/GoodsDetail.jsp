...
<div class="page-container" >
	<c:forEach items="${list}" var="m">
		<div class="row cl">
			<label class="form-label col-xs-6 col-sm-2">商品名称:</label>
			<div class="formControls col-xs-6 col-sm-9">
				<input type="text" class="input-text" value="${m.gname}" readonly="readonly">
			</div>
		</div><br>
		<div class="row cl">
			<label class="form-label col-xs-6 col-sm-2">商品详情:</label>
			<div class="formControls col-xs-6 col-sm-9">
		...
		<div class="row cl" >
			<div class="col-xs-8 col-sm-9 col-xs-offset-6 col-sm-offset-9">
				<a  href="javascript:history.go(-1)"><button class="btn btn-primary radius"><i class="Hui-iconfont">&#xe632;</i> 确认</button></a>
...
$(function(){
	...
	$("#AddBtn").click(function(){
	    ...
	    //var gooddetail = UE.getEditor("editor").getContent();	
		//var gooddetail = $("#editor").html();
		//gooddetail = encodeURIComponent(editor);
		var gooddetail=encodeURIComponent(encodeURIComponent(ue.getContent()));
		...
		if(image == null){
			layer.msg("请至少上传一张商品图片!",{icon:6,time:1000});
			return false;
		}
		...
		layer.confirm("修改商品?",function(index){
			...
			$.ajax({
				...
				data:"&goodname="+goodname+"&gDetail="+goodprice+"&gDetail="+gooddetail+"&file="+image+"&gId="+gId+"&gstatus="+gstatus,
				type:"post",
