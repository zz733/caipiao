...
<body ng-app="myapp" ng-controller="myctrl">
	<div class="page-container">
		...
		<div class="row cl">
			<label
				class="form-label col-xs-5 col-sm-1 col-xs-offset-5 col-sm-offset-1"
				style="width: 9%"> <span class="c-red">*</span>库存:
			</label>
			<div class="formControls col-xs-4 col-sm-4">
				<input type="text" name="kuchun" id="kuchun" placeholder="0"
					value="" class="input-text" style="width: 60%">
			</div>
		</div>
		<br />
		<div class="row cl">
		...
		<div class="row cl">
			<label
				class="form-label col-xs-4 col-sm-1 col-xs-offset-4 col-sm-offset-1"
				style="width: 9%"> <span class="c-red">*</span>默认图片：
			</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label
				class="form-label col-xs-4 col-sm-1 col-xs-offset-4 col-sm-offset-1"
				style="width: 9%"> <span class="c-red">*</span>商品图片：
			</label>
			<div class="formControls col-xs-8 col-sm-9">
			...
			$("#AddBtn")
					.click(
							function() {
								...
								var select = document
										.getElementsByClassName("select")[0].value;
								...
								layer
										.confirm(
												...
												function(index) {
													...
													$
															.ajax({
																url : "${pageContext.request.contextPath}/goods.do?p=addGoods",
																data : "&goodname="
																		+ goodname
																		+ "&goodprice="
																		+ goodprice
