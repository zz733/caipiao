...
<![endif]-->
	...
	<body>
		<form id="f"
			action="${pageContext.request.contextPath}/kaijiang3d.do?p=fenye"
			method="post" autocomplete="off">
			<nav class="breadcrumb">
			<i class="Hui-iconfont">&#xe67f;</i> 首页
			<span class="c-gray en">&gt;</span> 3D管理
			<span class="c-gray en">&gt;</span> 3D数据
			</a>
			</nav>
			<div class="page-container">
				<div class="text-c">
					...
					<input type="text" class="input-text" style="width: 250px"
						placeholder="输入期号" id="qishu" name="kjQishu" value="${param.kjQishu}">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			...
			<span class="l"> <a href="javascript:;"
				onclick="qiuhao_add('球号入库','${pageContext.request.contextPath}/kaijiang3d.do?p=getMaxQishu','800','450')"
						...
						<tr class="text-c">
							...
							<td class="td-manage">
								...
								<a title="编辑"
									...
									onclick="qiuhao_update('编辑','${pageContext.request.contextPath}/kaijiang3d.do?p=toEdit&id=${m.id}','800','450')"
									class="ml-5" style="text-decoration: none"><i
									class="btn btn-success">编辑</i> </a>

								<a title="删除"
									_href="${pageContext.request.contextPath }/kaijiang3d.do?p=del&id=${m.id}"
									onclick="del(${m.id},this)"
									class="ml-5" style="text-decoration: none"><i
									class="btn btn-success">删除</i> </a>
										...
										<tr>
											...
											<td width="87%">
												<input name="Submit23222" type="submit" value="GO"
													onclick=
	go(document.getElementById('page2').value);
/>
											</td>
										</tr>
									</table>
	...
	function del(id,a)
	{
	   var url  = '${pageContext.request.contextPath }/kaijiang3d.do?p=del';
	   var data = {id:id};
